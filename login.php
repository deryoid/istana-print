...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/istana-print.png') }}">
  <title>Login |PERCETAKAN ISTANA PRINT BANJARMASIN</title>
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h2 style="color:red; font-family: Gill Sans, sans-serif;"><b> PERCETAKAN ISTANA PRINT BANJARMASIN </b></h2>
        <h3>
          <img src="<?= base_url() ?>/assets/dist/img/istana-print.png" style="margin-top: 20px; margin-bottom: 20px;" width="280px;" height="170px;">
      ...
      <div class="card-body login-card-body">
        ...
        <form action="" method="POST">
          ...
          <button type="submit" name="login" class="btn btn-danger btn-block btn-xm"><i class="fa fa-sign-in-alt mr-1"></i>Masuk</button>
          <br>
        </form>
